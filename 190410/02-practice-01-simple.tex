...
\begin{frame}[fragile]{Упражнение: сборка кода}
	\begin{enumerate}
		\item Качаем решение с \href{https://github.com/yeputons/fall-2017-paradigms/raw/master/171023/sources/01-simple.cpp}{GitHub}.
...
\begin{frame}{Упражнение}
	...
	\end{enumerate}
	\href{https://github.com/yeputons/fall-2017-paradigms/raw/master/171023/sources/02-detached.cpp}{Код}
\end{frame}
